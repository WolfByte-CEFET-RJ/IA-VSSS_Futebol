"""
Utilização de pivôs baseado no exemplo de tanque do Pymunk:
https://github.com/viblo/pymunk/blob/master/pymunk/examples/tank.py
...
def create_ball(pos):
    ...
    pivot.max_force = BALL_FRICTION  # emulate linear friction
    space.add(pivot)
...
def create_robot(pos):
    ...
    # Add friction to the robot
    static_body = space.static_body
    pivot_l = pymunk.PivotJoint(static_body, body, (0, 0), (0, -ROBOT_SIZE/2))
    pivot_l.max_bias = 0  # disable joint correction
    pivot_l.max_force = ROBOT_FRICTION  # emulate linear friction
    space.add(pivot_l)

    pivot_r = pymunk.PivotJoint(static_body, body, (0, 0), (0, ROBOT_SIZE/2))
    pivot_r.max_bias = 0  # disable joint correction
    pivot_r.max_force = ROBOT_FRICTION  # emulate linear friction
    space.add(pivot_r)
